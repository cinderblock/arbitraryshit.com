...
- [x] 2nd post published 2026-07-08: "A New Pandora Desktop App" (cinderblock/pandora-desktop, Tauri; Cameron prose, pinned to 178a202). Hardened refresh-github-stats.ts to skip a not-yet-pushed repo instead of crashing (per-repo try/catch) — was needed because the post was drafted before the repo existed.
